...
const resources = {
  pt: {
    translation: {
      ...
      pricing: { title: "Planos Escaláveis", subtitle: "Escolha a infraestrutura ideal para a fase atual do seu negócio.", popular: "Mais Popular", month: "/mês", btn_start: "Começar Agora" },
  ...
  en: {
    translation: {
      ...
      pricing: { title: "Scalable Plans", subtitle: "Choose the ideal infrastructure for your current business stage.", popular: "Most Popular", month: "/month", btn_start: "Get Started" },
  ...
  es: {
    translation: {
      ...
      authority: { events: "eventos/día", latency: "latencia", data: "Protección de Datos", ready: "Listo" },
      ...
      pricing: { title: "Planes Escalables", subtitle: "Elige la infraestructura ideal para tu negocio.", popular: "Más Popular", month: "/mes", btn_start: "Empezar Ahora" },
